...
class material {
  public:
    ...
    virtual bool scatter(
      const ray& r_in, const hit_record& rec, color& attenuation_color, ray& scattered_ray
    ) const {
      return false;
    }
};
...
class dielectric : public material {
  public:
    ...
    const override {
      ...
      scattered_ray = ray(rec.p, direction, r_in.time());
...
class isotropic : public material {
  public:
    ...
    bool scatter(const ray& r_in, const hit_record& rec, color& attenuation_color, ray& scattered_ray)
    const override {
      scattered_ray = ray(rec.p, random_unit_vector(), r_in.time());
      attenuation_color = tex->value(rec.u, rec.v, rec.p);
      return true;
    }
